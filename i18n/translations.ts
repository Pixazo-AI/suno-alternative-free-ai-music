...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to Pixazo',
    ...
    about: 'About',
    version: 'Version',
    localAIMusicGenerator: 'AI Music Generator',
    poweredBy: 'Powered by Pixazo AI. Open source and free to use.',
    ...
    emailBody: 'Hey!\n\nI created this AI-generated song and thought you\'d love it:\n\n"{title}" by {creator}\n{style}\n\nListen here: {url}\n\nMade with Pixazo - free and open source local AI music generation!',
  ...
  zh: {
    ...
    poweredBy: '由 Pixazo AI 驱动。开源免费使用。',
    createdBy: '开发者 Ambsd',
  ...
  ja: {
    ...
    poweredBy: 'Pixazo AIを搭載。オープンソースで無料で使用できます。',
    createdBy: '開発者 Ambsd',
    ...
    emailBody: 'こんにちは！\n\n私がこのAI生成の曲を作りました。気に入ってもらえると思います：\n\n「{title}」by {creator}\n{style}\n\nここで聴いてください：{url}\n\nPixazoで作成 - 無料でオープンソースのローカルAI音楽生成！',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'Pixazo에 오신 것을 환영합니다',
    ...
    poweredBy: 'Pixazo AI 기반. 오픈 소스이며 무료로 사용 가능합니다.',
    createdBy: '개발자 Ambsd',
