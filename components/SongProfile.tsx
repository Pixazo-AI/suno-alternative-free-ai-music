...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Pixazo`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Pixazo.`;
...
const resetMetaTags = () => {
    document.title = 'Pixazo - Local AI Music Generator';
    const defaultDescription = 'Create original music with AI locally. Generate songs in any style with custom lyrics and professional quality using Pixazo.';
    ...
    updateMeta('meta[property="og:title"]', 'Pixazo - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Pixazo - Local AI Music Generator');
